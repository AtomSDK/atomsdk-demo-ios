...
- Increase iOS and macOS Targets.

### Version 6.10.0

#### Improved
- Stability improvements to eliminate minor, random crashes.
...
- Improvements for Unable To Connect (UTC) cases.
...
#### Improved
- Provide Interface For On Demand Custom Rules.
